                        ...
                        <form method="POST" action="{{ route('update.brand') }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input name="brand_name" value="{{ $data->brand_name }}" type="text" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <img id="showImage" src="{{ (!empty($data->brand_image))? url($data->brand_image):url('upload/no_image.jpg') }}" alt="Admin" class="rounded-circle p-1 bg-primary" style="width:100px; height: 100px;">
                                </div>
                            </div>
