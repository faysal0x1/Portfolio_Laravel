    ...
    <div class="ms-auto">
        <div class="col">
            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                data-bs-target="#exampleVerticallycenteredModal">Add Eduction</button>
            @include('backend.education.add_education')
        </div>
    </div>
</div>
...
@include('backend.education.update_education')
...
<script>
    ...
    try {
        let res = await axios.get('/admin/get/education');
...
async function deleteItem(id) {
    try {
        let res = await axios.delete(`/admin/educations/${id}`, {
            headers: {
