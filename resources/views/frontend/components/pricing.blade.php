      ...
      <div class="col-lg-8 col-xl-7">
        ...
        <div class="navigation-wrapper">
          <ul class="nav " id="myTab" role="tablist">
            <li class="nav-item ">
              <a class="nav-style" id="test-tab" data-bs-toggle="tab" href="inbio.html#test" role="tab"
                aria-controls="test" aria-selected="false">Static</a>
            </li>

            <li class="nav-item  recommended">
              <a class="nav-style active" id="profile-tab" data-bs-toggle="tab" href="inbio.html#profile"
                role="tab" aria-controls="profile" aria-selected="true">Standard</a>
            </li>
            <li class="nav-item">
              <a class="nav-style" id="contact-tab" data-bs-toggle="tab" href="inbio.html#contact" role="tab"
            ...
            <div class="tab-pane fade " id="test" role="tabpanel" aria-labelledby="test-tab">
              ...
              <div class="rn-pricing">
                ...
                <div class="pricing-footer">
                  <a href="inbio.html#" class="rn-btn d-block">
                    <span>ORDER NOW</span>
