        ...
        <div class="contact-about-area">
          ...
          <div class="social-area">
            ...
            <div class="social-icone">
              <a href="inbio.html#"><i data-feather="facebook"></i></a>
              <a href="inbio.html#"><i data-feather="linkedin"></i></a>
              <a href="inbio.html#"><i data-feather="instagram"></i></a>
            </div>
          </div>
        </div>
      </div>
      <div data-aos-delay="600" class="col-lg-7 contact-input">
        <div class="contact-form-wrapper">
          <div class="introduce">
            ...
            <form class="rnt-contact-form rwt-dynamic-form row" id="contact-form" method="POST" action="mail.htm">
