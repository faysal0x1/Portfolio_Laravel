                        ...
                        <div class="swiper-container">
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="service-box-single-item swiper-slide">
                                    ...
                                    <div class="icon"><img
                                            src="{{ asset('frontend/assets/images/icon/service-icon-1.png') }}" alt="">
                                    </div>
                                ...
                                <div class="service-box-single-item swiper-slide">
                                    <div class="inner-shape inner-shape-top-right"></div>
                                    <div class="icon"><img
                                            src="{{ asset('frontend/assets/images/icon/service-icon-2.png') }}" alt="">
                                    </div>
                                ...
                                <div class="service-box-single-item swiper-slide">
                                    <div class="inner-shape inner-shape-top-right"></div>
                                    <div class="icon"><img
                                            src="{{ asset('frontend/assets/images/icon/service-icon-3.png') }}" alt="">
                                    </div>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="project-box-single-item swiper-slide">
                            <div class="img-box">
                                ...
                                <div class="bg-image">
                                    <img src="{{ asset('frontend/assets/images/project/project-slider-img-1.jpg') }}"
                                        alt="">
                                </div>
                                <div class="image">
                                    <img src="{{ asset('frontend/assets/images/project/project-slider-img-1.jpg') }}"
                            ...
                            <div class="content">
                                <h4 class="title"><a href="project-details.html">Givest - Non Profit PSD Template</a>
                                </h4>
                        ...
                        <div class="project-box-single-item swiper-slide">
                            <div class="img-box">
                                <div class="bg-overlay"></div>
                                <div class="bg-image">
                                    <img src="{{ asset('frontend/assets/images/project/project-slider-img-2.jpg') }}"
                                        alt="">
                                </div>
                                <div class="image">
                                    <img src="{{ asset('frontend/assets/images/project/project-slider-img-2.jpg') }}"
                            ...
                            <div class="content">
                                <h4 class="title"><a href="project-details.html">Musion - Gardening Website Template</a>
                                </h4>
                        ...
                        <div class="project-box-single-item swiper-slide">
                            <div class="img-box">
                                <div class="bg-overlay"></div>
                                <div class="bg-image">
                                    <img src="{{ asset('frontend/assets/images/project/project-slider-img-3.jpg') }}"
                                        alt="">
                                </div>
                                <div class="image">
                                    <img src="{{ asset('frontend/assets/images/project/project-slider-img-3.jpg') }}"
                        ...
                        <div class="project-box-single-item swiper-slide">
                            <div class="img-box">
                                <div class="bg-overlay"></div>
                                <div class="bg-image">
                                    <img src="{{ asset('frontend/assets/images/project/project-slider-img-4.jpg') }}"
                                        alt="">
                                </div>
                                <div class="image">
                                    <img src="{{ asset('frontend/assets/images/project/project-slider-img-4.jpg') }}"
                            ...
                            <div class="content">
                                <h4 class="title"><a href="project-details.html">Virtuf - Creative Agency Bootstrap 5
                                        Template</a></h4>
