                            ...
                            <div class="swiper-container">
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="service-box-single-item swiper-slide">
                                        ...
                                        <div class="icon"><img src="{{ asset('frontend/assets/images/icon/service-icon-1.png') }}" alt=""></div>
                                    ...
                                    <div class="service-box-single-item swiper-slide">
                                        <div class="inner-shape inner-shape-top-right"></div>
                                        <div class="icon"><img src="{{ asset('frontend/assets/images/icon/service-icon-2.png') }}" alt=""></div>
                                    ...
                                    <div class="service-box-single-item swiper-slide">
                                        <div class="inner-shape inner-shape-top-right"></div>
                                        <div class="icon"><img src="{{ asset('frontend/assets/images/icon/service-icon-3.png') }}" alt=""></div>
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="project-box-single-item swiper-slide">
                                <div class="img-box">
                                    ...
                                    <div class="bg-image">
                                        <img src="{{ asset('frontend/assets/images/project/project-slider-img-1.jpg') }}" alt="">
                                    </div>
                                    <div class="image">
                                        <img src="{{ asset('frontend/assets/images/project/project-slider-img-1.jpg') }}" alt="">
                                    </div>
                            ...
                            <div class="project-box-single-item swiper-slide">
                                <div class="img-box">
                                    <div class="bg-overlay"></div>
                                    <div class="bg-image">
                                        <img src="{{ asset('frontend/assets/images/project/project-slider-img-2.jpg') }}" alt="">
                                    </div>
                                    <div class="image">
                                        <img src="{{ asset('frontend/assets/images/project/project-slider-img-2.jpg') }}" alt="">
                                    </div>
                            ...
                            <div class="project-box-single-item swiper-slide">
                                <div class="img-box">
                                    <div class="bg-overlay"></div>
                                    <div class="bg-image">
                                        <img src="{{ asset('frontend/assets/images/project/project-slider-img-3.jpg') }}" alt="">
                                    </div>
                                    <div class="image">
                                        <img src="{{ asset('frontend/assets/images/project/project-slider-img-3.jpg') }}" alt="">
                                    </div>
                            ...
                            <div class="project-box-single-item swiper-slide">
                                <div class="img-box">
                                    <div class="bg-overlay"></div>
                                    <div class="bg-image">
                                        <img src="{{ asset('frontend/assets/images/project/project-slider-img-4.jpg') }}" alt="">
                                    </div>
                                    <div class="image">
                                        <img src="{{ asset('frontend/assets/images/project/project-slider-img-4.jpg') }}" alt="">
                                    </div>
                                ...
                                <div class="swiper-container">
                                    ...
                                    <div class="swiper-wrapper">
                                        ...
                                        <div class="company-logo-single-item swiper-slide">
                                            <a href="#" class="image">
                                                <img src="{{ asset('frontend/assets/images/company-logo/company-logo-1.png') }}" alt="">
                                        ...
                                        <div class="company-logo-single-item swiper-slide">
                                            <a href="#" class="image">
                                                <img src="{{ asset('frontend/assets/images/company-logo/company-logo-2.png') }}" alt="">
                                        ...
                                        <div class="company-logo-single-item swiper-slide">
                                            <a href="#" class="image">
                                                <img src="{{ asset('frontend/assets/images/company-logo/company-logo-3.png') }}" alt="">
                                        ...
                                        <div class="company-logo-single-item swiper-slide">
                                            <a href="#" class="image">
                                                <img src="{{ asset('frontend/assets/images/company-logo/company-logo-4.png') }}" alt="">
                    ...
                    <div class="row mb-n5">
                        <div class="col-12 mb-5">
                            ...
                            <div class="blog-feed-single-item">
                                ...
                                <a href="blog-details-sidebar-left.html" class="image">
                                    <img src="{{ asset('frontend/assets/images/blog/blog-feed-img-1.jpg') }}" alt="">
                                </a>
                        ...
                        <div class="col-12 mb-5">
                            ...
                            <div class="blog-feed-single-item">
                                <div class="inner-shape inner-shape-top-right"></div>
                                <a href="blog-details-sidebar-left.html" class="image">
                                    <img src="{{ asset('frontend/assets/images/blog/blog-feed-img-2.jpg') }}" alt="">
                                </a>
                                <div class="content-box">
                                    <div class="content">
                                        <div class="post-meta">
                        ...
                        <div class="col-12 mb-5">
                            ...
                            <div class="blog-feed-single-item">
                                <div class="inner-shape inner-shape-top-right"></div>
                                <a href="blog-details-sidebar-left.html" class="image">
                                    <img src="{{ asset('frontend/assets/images/blog/blog-feed-img-3.jpg') }}" alt="">
                                </a>
                                <div class="content-box">
                                    <div class="content">
                                        <div class="post-meta">
